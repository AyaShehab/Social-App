...
export default function DropdownActionComment({ comment, postId }) {
  ...
  const { mutate: handleUpdateComment, isPending: isUpdating } = useMutation({
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-md rounded-2xl p-5 shadow-xl space-y-4 relative animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto">
            ...
            <textarea
              ...
              placeholder="Update your comment body..."
            ...
            <div className="flex items-center justify-between border-t border-gray-100 pt-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  disabled={isUpdating || (!commentText.trim() && !imagePreview)}
